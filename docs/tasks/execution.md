...
所有前端任务同时完成桌面和手机。任务卡列具体两端主节点与状态节点；沿用 [设计交接](../design/handoff.md) 的断点、中文、主题、表单外标签、44px触控、焦点回归、固定底栏、软键盘/安全区与减少动态效果。检查360/390/430/768和桌面相关宽度，以及加载/空/错误/成功/禁用；不适用项写理由。
